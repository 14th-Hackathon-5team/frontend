...
export const inputClass =
  'w-full rounded-xl border-2 border-background-200 bg-background-50 px-4 py-3 text-sm text-foreground-950 placeholder-foreground-400 focus:outline-none focus:ring-2 focus:ring-primary-500'
