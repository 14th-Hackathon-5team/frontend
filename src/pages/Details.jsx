              ...
              <div className="space-y-3">
                {guides.map((guide) => (
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-2xl border-2 border-gray-300 bg-background-50 p-4 transition-colors hover:border-primary-300 hover:bg-primary-50"
                  >
