  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        <div className="divide-y divide-background-200 overflow-hidden glass-surface rounded-2xl">
          <button
            type="button"
      ...
      <div className="divide-y divide-background-200 glass-surface rounded-2xl">
        <button
          type="button"
